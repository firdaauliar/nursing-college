...
@section('content')
    ...
    <header class="ex-header bg-gray">
        <div class="container px-4 sm:px-8 xl:px-4">
            <h1 class="xl:ml-24">Practicum Modules</h1>
    ...
    <div class="ex-basic-1 pt-4">
        <div class="container px-4 sm:px-8 xl:px-32">
            <p class="mb-2">Welcome to the Nursing Laboratory Practice Modules page, a digital platform that provides easy
                access to various learning modules to support practice activities in nursing laboratories. This page is
                designed to help students prepare well, understand procedures, and master nursing skills through structured
                and comprehensive guidance.</p>
        </div> <!-- end of container -->
