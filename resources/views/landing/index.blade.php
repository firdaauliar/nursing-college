...
<!-- Header -->
    {{-- <header id="header" class="relative pt-0 pb-28 md:pt-36 xl:pt-44 xl:pb-32 min-h-[27rem] overflow-hidden"> --}}
    <header id="header" class="relative xl:pb-32 min-h-screen md:pt-36 overflow-hidden">
        <!-- Background image -->
        <div class="absolute inset-0 -z-10 bg-[url('/img/nurse-header.jpg')] bg-cover bg-center w-full h-[27rem] xl:mt-28"
            style="background-image:  url('/img/nurse-header.jpg')"></div>

        <!-- Blur + white overlay -->
        <div class="absolute inset-0 -z-0 bg-blue-100/30 backdrop-blur-sm h-[27rem] xl:mt-28 backdrop-filter"></div>
        <div class="container to-animate">

            <div class="mb-16 lg:mt-32 xl:mt-40 relative to-animate">
                <h1 class="h1-large mb-5 font-semibold text-white">Nursing Laboratory of Poltekkes Sidoarjo</h1>
                <p class="text-white mb-8 grid grid-cols-2">Menjadi program studi penghasil tenaga perawat vokasi dalam keperawatan
                    intensif yang
                    memiliki moralitas dan integritas dengan keunggulan kualitas global pada tahun 2025</p>
    ...
    <div class="pt-4 pb-14 text-center">
        <div class="container px-4 sm:px-8 xl:px-4 to-animate">
            <p class="mb-4 text-gray-800 text-3xl leading-10 lg:max-w-5xl lg:mx-auto"> Team management mobile apps
                don’t get better than Pavo. It’s probably the best app in the world for this purpose. Don’t hesitate
                to
                give it a try today and you will fall in love with it</p>
        </div> <!-- end of container -->
    </div>
    <!-- end of introduction -->
        ...
        <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
            <div class="lg:col-span-7">
                <div class="mb-12 lg:mb-0 xl:mr-14">
                    <img class="inline" src="img/details-2.jpg" alt="alternative" />
                </div>
            </div> <!-- end of col -->
            <div class="lg:col-span-5">
                <div class="xl:mt-12">
    ...
    <div id="pricing" class="cards-2">
        ...
        <div class="container px-4 pb-px sm:px-8">
            ...
            <p class="mb-16 text-white lg:max-w-3xl lg:mx-auto"> Our pricing plans are setup in such a way that any
                user can start enjoying Pavo without worrying so much about costs. They are flexible and work for
                any
                type of industry </p>
