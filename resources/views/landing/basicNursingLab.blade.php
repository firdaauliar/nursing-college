...
@section('content')
    ...
    <header class="ex-header bg-gray">
        <div class="container px-4 sm:px-8 xl:px-4">
            <h1 class="xl:ml-24">BASIC NURSING LABORATORY</h1>
    ...
    <div class="ex-basic-1 pt-4">
        <div class="container px-4 sm:px-8 xl:px-32">
            <p class="mb-4"> The Basic Nursing Laboratory is a clinical nursing laboratory that prepares students to
                fulfill basic human needs before entering the practice field. The fulfillment of basic needs is a basic form
                of service that must be understood by a nurse, where every client must have their basic needs met based on
                the level of dependence they need.</p>
            <p class="mb-4"> Competencies learned in the Basic Nursing Laboratory are the fulfillment of Personal Hygiene,
                Catheterization, NG-Tube installation, Basic Wound Care, Medication (Administration of drugs per oral,
                parenteral, sublingual, topical), Infusion Installation, Venous Blood Drawing, Hecting (Wound Suture) and
                Stitch Lift.</p>
            <p class="mb-6">to support learning, this room is equipped with Wound Care Set, Personal Hygiene Set, Urine
                Catheterization Set (Male and Female), NG-Tube Insertion Set, Injection Set, Enema Set, Vital Signs Checking
                Set, Hecting and Suture Lifting Set, Medication Set, Patient Care Simulator, Surgical Sally Bandaging
                Simulation, Intramuscular Injection Model, Complete Surgical Care Series, Electrical Bed, Sterilizer,
                Various Mobilization Aids.</p>
        </div> <!-- end of container -->
    </div> <!-- end of ex-basic-1 -->
    <!-- end of basic -->
    ...
    {{-- <div class="ex-basic-1 pt-6 pb-12">
        <div class="container px-4 sm:px-8 xl:px-32">
            <p class="mb-12"> Features include an eye catching morphtext in the header, details lightbox for more
            ...
            <img class="inline mb-12" src="{{ asset('pavo/images/article-details-small.jpg') }}" alt="alternative" />
            <p class="mb-4"> Some useful extra pages are bundled with the template lik article details, terms
                ...
                your mobile app stand out. </p>
            <p class="mb-12"> Leon is an easy to customize landing page HTML template built with Tailwind CSS for
                promoting mobile apps to the online audience and making visitors download them from app stores. This
                template is built with HTML and Tailwind CSS to ensure the highest flexibility for all users.</p>
            <div class="text-box mb-12">
                <h3 class="mb-2">Visitors love a beautiful and efficient website</h3>
                <p class="mb-4"> All designers, developers and tech-savvy people will be able to customize this
                    ...
                    extra pages for article details, terms.</p>
            </div> <!-- end of text-box -->
            <p class="mb-6"> Together with touches of call to action green, the overall landing page design will
                ...
                customer logos and working forms.</p>
            <ul class="list-unstyled mb-12 space-y-2">
                <li class="flex">
                    <i class="fas fa-square"></i>
                    <div class="flex-1 ml-2">
                        <strong>Card slider</strong> for testimonials, statistics numbers for important values image
                        slider for logos
                    </div>
                </li>
                <li class="flex">
                    <i class="fas fa-square"></i>
                    <div class="flex-1 ml-2">
                        <strong>Dropdown navigation</strong> and useful extra pages for article details, terms
                ...
                <li class="flex">
                    <i class="fas fa-square"></i>
                    <div class="flex-1 ml-2">
                        <strong>Clean light design</strong> mixing purple, orange and gray hues with one color
                        backgrounds to maximize
                    </div>
                </li>
                <li class="flex">
                    <i class="fas fa-square"></i>
                    <div class="flex-1 ml-2">
                        <strong>Together with</strong> touches of call to action green, the overall landing page design
                        will showcase your app
                    </div>
                </li>
                <li class="flex">
                    <i class="fas fa-square"></i>
                    <div class="flex-1 ml-2">
                        <strong>This template</strong> is built with HTML and Tailwind CSS to ensure the highest
    ...
    <!-- end of basic -->
     ...
     <!-- Testimonials -->
        <div class="slider-1 py-16 bg-gray">
            <div class="container px-4 sm:px-8">
                ...
                <div class="slider-container">
                    <div class="swiper-container card-slider h-svh w-80">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="inline object-cover lg:h-[85vh] lg:w-full" src="{{ asset('img/poltekkes-basic-lab-2.jpg') }}" alt="alternative" />
                                </div>
                            </div> <!-- end of swiper-slide -->
                            <!-- end of slide -->
                            <!-- Slide -->
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="inline object-cover lg:h-[85vh] lg:w-full" src="{{ asset('img/poltekkes-basic-lab-3.jpg') }}" alt="alternative" />
                                </div>
                            </div> <!-- end of swiper-slide -->
                            <!-- end of slide -->
                            <!-- Slide -->
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="inline object-cover lg:h-[85vh] lg:w-full" src="{{ asset('img/poltekkes-basic-lab-4.jpg') }}" alt="alternative" />
                                </div>
                            </div> <!-- end of swiper-slide -->
                            <!-- end of slide -->
                            <!-- Slide -->
                            <div class="swiper-slide">
                                <div class="card">
                                    <img class="inline object-cover lg:h-[85vh] lg:w-full" src="{{ asset('img/poltekkes-basic-lab-5.jpg') }}" alt="alternative" />
                                </div>
                            </div> <!-- end of swiper-slide -->
                            <!-- end of slide -->
