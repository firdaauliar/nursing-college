...
<head>
    ...
    {{-- <title>{{ config('app.name', 'Nursing-polkesda') }}</title> --}}
...
<body class="font-sans antialiased bg-surface">
    <div class="min-h-screen xl:mt-20 md:mt-14">
        ...
        <main>
            <!--start the project-->
            <div id="main-wrapper" class="flex xl:pr-0">
                <aside id="application-sidebar-brand"
                    class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transform hidden xl:block xl:translate-x-0 xl:end-auto xl:bottom-0 fixed xl:top-[90px] xl:left-0 top-0 left-0 with-vertical h-screen z-[998] shrink-0 w-[270px] shadow-md xl:rounded-md rounded-none bg-white left-sidebar transition-all duration-300">
                    <x-sidebar></x-sidebar>
                </aside>
                <!-- Page Wrapper -->
                <div class="w-full page-wrapper xl:px-6 px-0 xl:ml-[270px]">
                    <!-- Main Content -->
                    <main class="h-full  max-w-full">
                        <div class="container full-container p-0 flex flex-col gap-6">
                            <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-x-0 lg:gap-y-0 gap-y-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="flex  justify-between mb-5">
                                                {{-- <h4 class="text-gray-500 text-lg font-semibold sm:mb-0 mb-2">{{$header}}</h4> --}}
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="text-gray-500 text-lg font-semibold mb-4">Traffic Distribution
                                        </h4>
                                        <div class="flex items-center justify-between gap-12">
                                            <div>
                                                <h3 class="text-[22px] font-semibold text-gray-500 mb-4">$36,358
                                                </h3>
                                    ...
                                    <ul class="timeline-widget relative">
                                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                                            ...
                                            <div class="timeline-desc py-[6px] px-4">
                                                <p class="text-gray-500 text-sm font-normal">Payment received from
                                                    John Doe of $385.90</p>
                                            </div>
                                        </li>
                                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                                            <div
                                        ...
                                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                                            ...
                                            <div class="timeline-desc py-[6px] px-4">
                                                <p class="text-gray-500 text-sm font-normal">Payment was made of
                                                    $64.95 to Michael</p>
                                            </div>
                                        </li>
                                        ...
                                        <li class="timeline-item flex relative overflow-hidden min-h-[70px]">
                                            ...
                                            <div class="timeline-desc py-[6px] px-4">
                                                <p class="text-gray-500 text-sm font-semibold">New arrival recorded
                                                </p>
                                            </div>
                                        </li>
                            ...
                            <div class="col-span-2">
                                <div class="card h-full">
                                    <div class="card-body">
                                        <h4 class="text-gray-500 text-lg font-semibold mb-5">Top Paying Clients
                                        </h4>
                                            ...
                                            <table class="text-left w-full whitespace-nowrap text-sm text-gray-500">
                                                <thead>
                                                    <tr class="text-sm">
                                                        ...
                                                        <th scope="col" class="p-4 font-semibold">Hour Rate
                                                        </th>
